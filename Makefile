debug_tool:
	...
	g++ src/pt_profile/tool.cpp --std=c++1z build/.obj/breakpoint.o build/.obj/tokenizer.o build/.obj/debugger.o -Isrc/ -I/home/harvey/software/linenoise/linenoise-v1 -L/home/harvey/software/linenoise/linenoise-v1/lib -llinenoise -o build/tool
clean:
	rm -rf build
