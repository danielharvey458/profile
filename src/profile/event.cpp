...
#define ADD_EVENT(type, name)                           \
        ...
        ADD_EVENT(PERF_TYPE_SOFTWARE, PERF_COUNT_SW_CPU_CLOCK);
        ADD_EVENT(PERF_TYPE_SOFTWARE, PERF_COUNT_SW_TASK_CLOCK);
        ADD_EVENT(PERF_TYPE_SOFTWARE, PERF_COUNT_SW_PAGE_FAULTS);
        ADD_EVENT(PERF_TYPE_SOFTWARE, PERF_COUNT_SW_CONTEXT_SWITCHES);
        ADD_EVENT(PERF_TYPE_SOFTWARE, PERF_COUNT_SW_CPU_MIGRATIONS);
        ADD_EVENT(PERF_TYPE_SOFTWARE, PERF_COUNT_SW_PAGE_FAULTS_MIN);
        ADD_EVENT(PERF_TYPE_SOFTWARE, PERF_COUNT_SW_PAGE_FAULTS_MAJ);
        ADD_EVENT(PERF_TYPE_SOFTWARE, PERF_COUNT_SW_ALIGNMENT_FAULTS);
        ADD_EVENT(PERF_TYPE_SOFTWARE, PERF_COUNT_SW_EMULATION_FAULTS);
        ADD_EVENT(PERF_TYPE_SOFTWARE, PERF_COUNT_SW_DUMMY);
#undef ADD_EVENT
  ...
  bool operator < (const Event lhs, const Event rhs)
  {
    return std::pair (lhs.type (), lhs.event ()) <
           std::pair (rhs.type (), rhs.event ());
  }
}
